...
import { Container, HStack, Image, Spinner, Text, View, VStack } from 'native-base';
...
function CarParkMap() {
	...
	//console.log({ LATITUD_DELTA, LONGITUDE_DELTA });
	...
	useEffect(() => {
		...
		animation.addListener(({ value }) => {
			...
			//console.log('selector : ', selector.districtData.length);
			...
			mapRef.animateToRegion(
				{
					latitude,
					longitude,
					latitudeDelta: 0.006, // mapView zoom in level when scrolling card
					longitudeDelta: 0.006, // mapView zoom in level when scrolling card
				},
				350
			);
			console.log((selector.districtData[index] as any)['name']);
